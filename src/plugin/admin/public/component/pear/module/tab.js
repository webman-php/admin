layui.define(['jquery', 'element'], function (exports) {
  ...
  // 获取当前选项卡选项
  var getCurrentTabItem = function (elem) {
    return $(".layui-tab[lay-filter='" + elem + "'] .layui-tab-title .layui-this");
  }

  // 加载空 iframe
  var loadBlankIframe = function (elem, id) {
    if (id === undefined) {
      id = getCurrentTabItem(elem).attr("lay-id");
    }
  ...
  pearTab.prototype.delCurrentTabByElem = function (elem, callback) {
    var currentTab = getCurrentTabItem(elem);
    if (currentTab.find("span").is(".able-close")) {
