...
<html lang="zh-cn">
	<head>
		...
		<style>
			...
			.content .layui-btn-md, .content .layui-btn-sm, .content .layui-btn-xs, .content .layui-btn {
				line-height: 100%;
				letter-spacing: 2px;
				padding: 0 15px;
				font-weight: 400;
				...
				<div class="layui-col-md1">
					<div class="layui-card nav click-but">
						...
						<div class="layui-card-body">
							...
							<button class="layui-btn layui-btn-sm" plain data-size="block" data-type="icon">图标</button>
							<button class="layui-btn layui-btn-sm" plain data-size="block" data-type="multiSelect">下拉多选</button>
							<button class="layui-btn layui-btn-sm" plain data-size="block" data-type="treeSelectOne">树单选</button>
							<button class="layui-btn layui-btn-sm" plain data-size="block" data-type="tree">树多选</button>
							<button class="layui-btn layui-btn-sm" plain data-size="block" data-type="upload">上传文件</button>
							<button class="layui-btn layui-btn-sm" plain data-size="block" data-type="uploadImg">上传图片</button>
					...
					<div class="layui-card nav">
						...
						<div class="layui-card-body">
							...
							<button class="layui-btn layui-btn-sm" plain data-size="inline" data-type="icon">图标</button>
							<button class="layui-btn layui-btn-sm" plain data-size="inline" data-type="multiSelect">下拉多选</button>
							<button class="layui-btn layui-btn-sm" plain data-size="inline" data-type="treeSelectOne">树单选</button>
							<button class="layui-btn layui-btn-sm" plain data-size="inline" data-type="tree">树多选</button>
							<button class="layui-btn layui-btn-sm" plain data-size="inline" data-type="upload">上传文件</button>
							<button class="layui-btn layui-btn-sm" plain data-size="inline" data-type="uploadImg">上传图片</button>
							<button class="layui-btn layui-btn-sm" plain data-size="block" data-type="submit">提交</button>
						</div>
					</div>
					<div class="layui-card nav">
						<div class="layui-card-body">
							<button class="layui-btn layui-btn-danger layui-btn-sm del-form" data-type="del"> <i class="layui-icon layui-font-16">&#xe640;</i></button>
						</div>
					</div>
