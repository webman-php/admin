...
<html lang="zh-cn">
    ...
    <div class="layui-card">
        ...
        <script type="text/html" id="table-toolbar">
            <button class="layui-btn layui-btn-primary layui-btn-md" lay-event="add" permission="app.admin.table.create">
                <i class="layui-icon layui-icon-add-1"></i>创建表格
            </button>
            <button class="layui-btn layui-btn-danger layui-btn-md" lay-event="batchRemove" permission="app.admin.table.drop">
                <i class="layui-icon layui-icon-delete"></i>删除表格
            </button>
        </script>

        <script type="text/html" id="table-bar">
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="edit" permission="app.admin.table.modify">编辑</button>
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="remove" permission="app.admin.table.drop">删除</button>
            <button class="layui-btn layui-btn-xs tool-btn" lay-event="crud" permission="app.admin.table.crud">一键菜单</button>
        </script>
        ...
        <script>
            ...
            layui.use(["table", "form", "common", "popup"], function() {
                ...
                $(document).on("click", ".tab-link", function () {
                    ...
                    parent.layui.admin.instances.tabPage.changePage({
                        id: table,
                        title: table + "表",
                        url: url,
                        type: "_iframe",
