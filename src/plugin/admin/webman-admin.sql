...
CREATE TABLE `wa_users` (
  ...
  `status` enum('normal','dsiabled','deleted') NOT NULL DEFAULT 'normal' COMMENT '状态',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-09-20  9:35:12
