...
CREATE TABLE `wa_options` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='选项表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-09-14 16:17:30
